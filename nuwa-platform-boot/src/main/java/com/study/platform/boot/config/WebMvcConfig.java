package com.study.platform.boot.config;
...
import com.study.platform.base.util.LocalDateTimeUtils;
import com.study.platform.boot.common.resolver.CurrentUserMethodArgumentResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        converters.add(nuwaJsonHttpMessageConverterEx());
    }

    @Bean
    public MappingJackson2HttpMessageConverter nuwaJsonHttpMessageConverterEx() {
