...
public class NuwaControllerAdvice {
    ...
    public Result handlerException(Exception exception, HttpServletRequest request) {
        ...
        Result result = Result.error(ResultCode.ERROR, errorSystem + exception.toString());
        return result;
    }
    ...
    public Result handlerSpringAOPException(Exception exception) {
        Result result = Result.error(ResultCode.ILLEGAL_REQUEST, errorSystem + exception.getMessage());
        return result;
    }
    ...
    public Result handlerSpringAOPException(MethodArgumentTypeMismatchException exception) {
        Result result = Result.error(ResultCode.PARAM_TYPE_MISMATCH, errorSystem + exception.getMessage());
        return result;
    }
    ...
    public Result handlerMethodArgumentNotValidException(MethodArgumentNotValidException methodArgumentNotValidException) {
        ...
        Result result = Result.error(ResultCode.PARAM_VALID_ERROR, errorSystem + errorMessage);
        return result;
    }
