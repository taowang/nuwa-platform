package com.study.nuwa.platform.constant;

import java.io.File;

/**
 * @author Nuwa
 * @ClassName: NuwaCodeGeneratorConstant
 * @Description: 常量类
 * @since 2021-10-12
 */
public class NuwaCodeGeneratorConstant {
     ...
     * Author
     */
    public static final String AUTHOR = "Nuwa";
